...
export H=$HOME
#export D=$H/Dropbox
export cal=$H/Dropbox/calendario
...
export biblio=$HOME/wiki
export papers=$HOME/wiki
...
if [ $? -eq 0 ]; then
    ...
    if [ -f "/home/ttdduu/miniconda3/etc/profile.d/conda.sh" ]; then
        . "/home/ttdduu/miniconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/ttdduu/miniconda3/bin:$PATH"
    fi
fi
unset __conda_setup
#<<< conda initialize <<<
